odoo.define('fbno_pos_partial_pymnt.customer_credit_amount', function (require) {
"use strict";

var models = require('point_of_sale.models');
var fields = models.load_fields('res.partner', 'custom_credit');
var fields = models.load_fields('pos.payment.method', 'is_credit');
...
//            var clients = this.currentOrder.get_client();
//            var plines = this.currentOrder.get_paymentlines();
//            var filterd_pymnt_lines = _.filter(plines, function (line) {
//            if (line.payment_method.is_credit) {
//                rpc.query({
//                model: 'res.partner',
//                method: 'update_partner_credit',
//                    args: [clients.id, line.amount],
//                });
//                console.log("777777777----",line.amount);
//            }
//                return line.payment_method.is_credit === true
//            });
//
//
////            this.currentOrder.paymentlines.each(function(line){
////					var self = this;
////					var journal = line.payment_method;
////					var amount = line.get_amount();
////					console.log("77777777788888888888888888----",amount);
...
////				});
//
//            console.log("888888888888888888888----",filterd_pymnt_lines);
