...
class WhatsappMessages(models.Model):
    ...
    fromMe = fields.Boolean('From Me', readonly=True, help="If message is sent then from me true else false")
    ...
    whatsapp_message_provider = fields.Selection([('whatsapp_chat_api', 'Whatsapp Chat Api'), ('gupshup', 'Gupshup'), ('meta', 'Meta')], string="Whatsapp Service Provider",
